        ...
        <div class="card-body">
            <form action="store" method="post">
                <div class="form-group">
                    ...
                    <input type="text" name="name" class="form-control border-secondary" value="<?php echo $data['data']['name']?>">
                </div>
                <div class="form-group">
                    <label for="name">Kelulusan</label>
                    <select name="kelulusan"  class="form-control border-secondary">
                        <option value="1" <?php echo($data['data']['kelulusan'] == 1 ? 'selected' : null ); ?> >Lulus</option>
                        <option value="0" <?php echo($data['data']['kelulusan'] == 0 ? 'selected' : null ); ?> >Tidak Lulus</option>
                    </select>
                </div>
